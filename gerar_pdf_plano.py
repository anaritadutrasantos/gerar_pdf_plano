...
def gerar_pdf_plano(conteudo_textual: str, nome_arquivo="Plano_de_Aula.pdf"):
    ...
    MAX_COL = 90
    y_min = 100
    y_top_texto = H - 150  # 🔹 Aumentei o espaço do cabeçalho
    ...
    def cabecalho():
        ...
        c.drawCentredString(W/2, H - 33, "Escola Céu Azul — Plano de Aula")
        c.setFont("Helvetica", 10)
        c.drawRightString(W - M, H - 65, f"Data: {datetime.datetime.now().strftime('%d/%m/%Y')}")
